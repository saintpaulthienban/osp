  ...
  const fetchMissionDetail = async () => {
    try {
      ...
      if (response.success) {
        ...
        if (
          missionData &&
          (!missionData.sister_name || !missionData.sister_birth_date)
        ) {
          try {
            ...
            if (sis?.success) {
              ...
              missionData.sister_birth_date =
                s.date_of_birth || missionData.sister_birth_date;
              missionData.sister_religious_name =
                s.saint_name || missionData.sister_religious_name;
              ...
              missionData.sister_avatar =
                s.photo_url || missionData.sister_avatar;
              missionData.sister_community =
                s.current_community_name || missionData.sister_community;
            }
          } catch (e) {
                      ...
                      <ListGroup.Item key={index} className="px-0">
                        <div className="d-flex justify-content-between align-items-center">
                          <div className="d-flex align-items-center">
                            ...
                            <div>
                              <div className="fw-semibold">
                                {doc.name || doc.filename || `Tệp ${index + 1}`}
                              </div>
                              <small className="text-muted">
                                {doc.size &&
              ...
              <Card.Body>
                <div className="text-center mb-3">
                  ...
                  <p className="text-muted mb-0">
                    {mission.sister_code || mission.sister_id}
                  </p>
                </div>
