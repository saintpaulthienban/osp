...
const up = async () => {
  ...
  try {
    ...
    `).catch(() => console.log("current_community_id column might already exist"));
    ...
    `).catch(() => console.log("FK for current_community_id might already exist"));
...
const down = async () => {
  ...
  try {
    ...
    await connection.query(`ALTER TABLE sisters DROP FOREIGN KEY IF EXISTS fk_sisters_current_community`).catch(() => {});
    await connection.query(`ALTER TABLE sisters DROP COLUMN IF EXISTS current_community_id`);
    await connection.query(`ALTER TABLE sisters DROP COLUMN IF EXISTS current_stage`);
    await connection.query(`ALTER TABLE sisters DROP COLUMN IF EXISTS family_address`);
    await connection.query(`ALTER TABLE sisters DROP COLUMN IF EXISTS siblings_count`);
    await connection.query(`ALTER TABLE sisters DROP COLUMN IF EXISTS mother_occupation`);
    await connection.query(`ALTER TABLE sisters DROP COLUMN IF EXISTS father_occupation`);
    await connection.query(`ALTER TABLE sisters DROP COLUMN IF EXISTS current_address`);
    await connection.query(`ALTER TABLE sisters DROP COLUMN IF EXISTS id_card_place`);
    await connection.query(`ALTER TABLE sisters DROP COLUMN IF EXISTS id_card_date`);
